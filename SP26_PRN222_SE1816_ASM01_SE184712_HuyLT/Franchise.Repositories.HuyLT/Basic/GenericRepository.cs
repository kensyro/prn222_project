...
namespace Franchise.Repositories.HuyLT.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected FranchiseManagementContext _context;

        public GenericRepository()
        {
            _context ??= new FranchiseManagementContext();
        }

        public GenericRepository(FranchiseManagementContext context)
        {
            _context = context;
        }
